...
pygame.init()
#tạo hình ảnh
m = 20 #kích thước chiều dài và chiều rộng 
Imgbody = pygame.transform.scale(pygame.image.load('img2.jpg'),(m,m))
Imghead = pygame.transform.scale(pygame.image.load('img1.png'),(m,m))
Imgfood = pygame.transform.scale(pygame.image.load('img3.jpg'),(m,m))
#tạo cửa sổ
#tạo khung trò chơi
...
def game_over():
    ...
    grect.midtop = (360,150) #vị trí của dòng chữ game over
    gameSurface.blit(gsurf,grect)
    show_score(0)
    pygame.display.flip()
    time.sleep(5) #thời gian chờ đóng
    pygame.quit()
    sys.exit()
#hàm show_score
